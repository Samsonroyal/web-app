...
export default function Note() {
  return (
    (<div className="flex h-screen w-full bg-yellow-100">
      <div
        className="flex flex-col w-72 border-r border-yellow-200 bg-yellow-50 dark:bg-yellow-900">
        <div
          className="flex items-center h-16 px-6 border-b border-yellow-200 bg-yellow-50 dark:bg-yellow-900">
          <svg
          ...
          <h1
            className="ml-2 text-lg font-semibold text-yellow-900 dark:text-yellow-100">Notes</h1>
        </div>
        <div className="flex-1 overflow-y-auto">
          <div className="py-4 space-y-2">
            <Button
              className="justify-start text-yellow-900 dark:text-yellow-100"
              variant="ghost">
              <svg
          ...
          <div className="p-4 space-y-2">
            <div
              className="flex items-center justify-between px-2 py-1 rounded-lg bg-yellow-200 dark:bg-yellow-800">
            ...
            <div
              className="flex items-center justify-between px-2 py-1 rounded-lg hover:bg-yellow-200 dark:hover:bg-yellow-800">
